...
namespace UnityEditor
{
	...
	internal class RuleTileEditor : Editor
	{
		...
		private void OnAddElement(ReorderableList list)
		{
			...
			rule.m_GameObject = tile.MDefaultGameObject;
		...
		public override void OnInspectorGUI()
		{
			...
			tile.MDefaultGameObject = EditorGUILayout.ObjectField("Default Game Object", tile.MDefaultGameObject, typeof(GameObject), false) as GameObject;
