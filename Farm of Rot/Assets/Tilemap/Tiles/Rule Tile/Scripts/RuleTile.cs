...
namespace UnityEngine
{
	...
	public class RuleTile : TileBase
	{
		...
		private const string s_Square = "iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAdElEQVQokWNgGCjAiE3QXEHhP7rYyQcPMNSyYNPYLymJYWAhA8N/dANQOLg0wg14/hzFBXAGusbC58/hbHRxmAEYzsZmQyEDA1YXMeF0IxGAIs1Ynd0vKclQyMDwH5mPDVAntAkZgK4Rq2aYAehi2FLYwAEA7gQ3NOgxDxMAAAAASUVORK5CYII=";
		...
		public static Texture2D[] arrows
		{
			get
			{
				if (s_Arrows == null)
				{
					...
					s_Arrows[10] = Base64ToTexture(s_Square);
				}
				return s_Arrows;
			}
		}
		...
		public virtual void RuleOnGUI(Rect rect, Vector2Int pos, int neighbor)
		{
			switch (neighbor)
			{
				...
				case RuleTile.TilingRule.Neighbor.NotThis:
					...
					break;
				case RuleTile.TilingRule.Neighbor.NotEmpty:
		...
		public GameObject MDefaultGameObject;
        ...
        public override void GetTileData(Vector3Int position, ITilemap tilemap, ref TileData tileData)
		{
			...
			tileData.gameObject = MDefaultGameObject;
		...
		public virtual bool RuleMatch(int neighbor, TileBase tile)
		{
			switch (neighbor)
			{
				...
				case TilingRule.Neighbor.NotEmpty: return tile;
			}
			return true;
		}
